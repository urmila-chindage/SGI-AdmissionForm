...
const registerDataChange = (e) => {
  ...
  const payload = {
    ...
    studentSign : studSign,
    adharNumber : student.studAdhar,
    contactStudent : student.studContact,
    contactParent : student.parentContact,
    email : student.email,
    nationality : student.studNationality,
    bloodGroup : student.studBloodGroup,
    fatherName : student.studFatherName,
    fatherOccupation : student.studFatherOccupation,
    motherName : student.studMotherName,
    category : selectedCategoryOption,
    Minority : selectedMinority,
    Disability : selectedDisability,
    Defence : selectedDefence,
    corrAddress : student.studCAddress,
    corrCity : student.studCCity,
    corrArea : studCArea,
    corrPincode : student.studCPincode,
    corrTaluka : student.studCTaluka,
    corrDistrict : student.studCDistrict,
    corrState : student.studCState,
    perAddress : student.studPAddress,
    perCity : student.studPCity,
    perArea : studPArea,
    perPincode : student.studPPincode,
    perTaluka : student.studPTaluka,
    perDistrict : student.studPDistrict,
    perState : student.studPState,
    sscyear : SscYear,
    sscMarksObtained : SscMarkObt,
    sscTotalMarks : SscMark,
    sscPercentage : SscPercent,
    hscYear : HscYear,
    hscMarksObtained : HscMarkObt,
    hscTotalMarks : HscMark,
    hscPercentage : HscPercent,
    diplomaYear : DipYear,
    diplomaMarksObtained : DipMarkObt,
    diplomaMarks : DipMark,
    diplomaPercentage : DipPercent,
    cetNo : CetRollNo,
    cetYear : CetYear,
    cetMathScore : CetMathScr,
    cetPhyScore : CetPhyScr,
    cetChemScore : CetChemScr,
    cetTotalScore : CetTotal,
    cetNo : JeeRollNo,
    jeeYear : JeeYear,
    jeeMathScore : JeeMathScr,
    jeePhyScore : JeePhyScr,
    jeeChemScore : JeeChemScr,
    jeeTotalScore : JeeTotal,
    sscMarkSheet : SscMarkSheet,
    hscMarkSheet : HscMarkSheet,
    cetMarksSheet : CetMarkSheet,
    jeeMarksSheet : JeeMarkSheet,
    diplomaMarksSheet : DiplomaMarkSheet,
    lctc : LCTC,
    domicile : Domicile,
    GapCerti : GapCerti,
    CastCerti : CastCerti,
    CastVali : CastVali,
    NonCreamy : NonCreamy,
    IncomeCerti : IncomeCerti,
    DefenceCerti : DefenceCerti,
    PhysicalDisCerti : PhysicalDisCerti,
    AdharX : AdharX,
    remark : Remark,
    studentAgree : agreeStudent,
    parentAgree : AgreeParent
